...
export default {
	...
	data(){
		return{
			...
			mensagem: '',
			prioridade: 1,
			prioridades: [  // criado uma lista de objetos para usar no exemplo do 'SELECT'
				{codigo: 1, nome: 'Baixa'},
				{codigo: 2, nome: 'Moderada'},
				{codigo: 3, nome: 'Alta'},
			],
			usandoCheckbox: [], // lista vazia, pois o checkbox geralmente é mais de uma opção
			usuario:{
				email: '', // INICIADO com valor vazio, pois será preenchido com o input do email
				senha:'',
				idade:33 // apenas por questão de exemplo que você pode deixar um valor preenchido default
			}
		}
	}
}
